...
class Register:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(
            file=r"E:\facial recognistion\Facial-Recognition-Based-Student-Attendance-System-main\img\nepal.jpg")
        lbl_lbl = Label(self.root, image=self.bg)
        lbl_lbl.place(x=0, y=0, relwidth=1, relheight=1)

        self.bg1 = ImageTk.PhotoImage(
            file = r"E:\facial recognistion\Facial-Recognition-Based-Student-Attendance-System-main\img\6.jpg")
        ...
        # img = ImageTk.PhotoImage(file = r"E:\facial recognistion\Facial-Recognition-Based-Student-Attendance-System-main\img\7.jpg")
        ...
        # img1 = ImageTk.PhotoImage(file = r"E:\facial recognistion\Facial-Recognition-Based-Student-Attendance-System-main\img\8.jpg")
...
# ...............function...................
    ...
    def register_data(self):
        if self.var_fname.get() == "" or self.var_email.get() == "" or self.var_securityQ.get() == "Select":
            ...
            conn=mysql.connector.connect(host="localhost",username="root",password="mrinal@",database="register")
