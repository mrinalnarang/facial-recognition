...
class Student:
    def __init__(self,root):
        ...
        img_left = Image.open(r"E:\project\images\bgwhite.png")
    ...
    def generate_dataset(self):
            if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
                ...
                try:
                    ...
                    casc_path = (r"E:\project\haarcascade_frontalface_default.xml")
                    face_classifier = cv2.CascadeClassifier(casc_path)
                    eye_cascade=cv2.CascadeClassifier("E:\project\haarcascade_eye.xml")
                    ...
                    while True:
                        ...
                        if face_cropped(my_frame) is not None:
                            ...
                            file_name_path="E:/project/data/user."+str(id)+"."+str(img_id)+".jpg"
